...
public welfare programs. Jha and Talathi (2021) examine the effects of
colonial institutions. Chanda and Cook (2022) investigate the impact of
demonetization. Beyer, Jain, and Sinha (2021) employ NTL data to study
the effects of COVID-19. In the context of convergence studies,
Chakravarty and Dehejia (2019) document significant regional disparities
in India using NTL data and caution that the goods and services tax may
...
steps. This approach enables readers to trace each result back to the
code that produced it. Moreover, Python and R notebooks can be executed
in the cloud using Google Colaboratory. While Stata is not open-source
software, its integration with the Jupyter environment provides a rich
interactive interface. This integration brings the same benefits of
...
further reduces the storage and processing burden (Tamiminia et al.
2020).
...
\(\boldsymbol{WX_t}\) denotes an \(N \times k\) matrix of spatially
...
of income or institutions. Tubadji (2025) proposes a Culture-Based
Development framework demonstrating that cultural participation
patterns---measured through revealed preferences in household
expenditure and survey data---predict regional economic trajectories
independently of standard economic variables. For India, the National
Sample Survey (NSS) 47th Round (1991--92) provides state-level data on
six dimensions of cultural participation: live cultural performance,
cultural telecast (TV/media), socio-cultural participation, cultural
heritage and religion, live cultural shows, and sports.

With nighttime lights data for the same period (1992) now available for
all 32 Indian states and union territories, we can examine the extent to
which luminosity is associated with regional cultural patterns.
...
statistically significant associations. Cultural telecast (TV/media)
exhibits a positive association (Spearman \(\rho\) = 0.370, \(p\) =
0.037): states with higher luminosity consume more culture through
television and media. Socio-cultural participation, by contrast, shows a
significant negative association (Pearson \(r\) = \$-\$0.476, \(p\) =
0.006): community-based cultural engagement is stronger in less luminous
states.

::: \{.cell \_sphinx\_cell\_id=`9142a698-d0a7-431c-b2f8-39059527779b'
quarto-private-1=`\{``key'':``execution'',``value'':\{``iopub.execute\_input'':``2026-04-07T12:48:36.114102Z'',``iopub.status.busy'':``2026-04-07T12:48:36.113779Z'',``iopub.status.idle'':``2026-04-07T12:48:36.755002Z'',``shell.execute\_reply'':``2026-04-07T12:48:36.752945Z''\}\}'
execution\_count=15\}
...
luminosity and cultural participation across 32 Indian states}
...
::: \{.cell \_sphinx\_cell\_id=`a32b1986-b694-4d46-8515-10330843efc7'
quarto-private-1=`\{``key'':``execution'',``value'':\{``iopub.execute\_input'':``2026-04-07T12:48:36.757818Z'',``iopub.status.busy'':``2026-04-07T12:48:36.757511Z'',``iopub.status.idle'':``2026-04-07T12:48:41.012648Z'',``shell.execute\_reply'':``2026-04-07T12:48:41.011236Z''\}\}'
execution\_count=16\}
...
participation across 32 Indian states}
...
increase or decrease cultural participation but rather transforms its
character. More luminous regions consume culture through modern media
infrastructure, while less luminous regions sustain culture through
community and religious engagement. The full exploration of all six
cultural indicators, including correlation analysis and additional
spatial clustering maps, is available in the accompanying computational
notebook. This preliminary evidence points to a richer relationship
between luminosity and socioeconomic life than GDP alone captures,
opening a direction for future research that integrates cultural
economics with satellite-based measurement.
...
activity (Henderson, Storeygard, and Weil 2012; X. Chen and Nordhaus
2011). However, DMSP-OLS data are subject to well-documented
limitations, including top-coding in bright urban cores and lack of
on-board calibration leading to inter-satellite inconsistencies.
Blooming artifacts that spatially blur light sources beyond their true
boundaries represent an additional concern (Abrahams, Oram, and
Lozano-Gracia 2018). These measurement issues can attenuate the
precision of convergence estimates, particularly in rapidly urbanizing
districts.
...
estimates of both direct and indirect effects, particularly in districts
...
measurement. Y. Chen, Ursavas, and Mendez (2024) show that
higher-quality VIIRS nighttime lights can predict sectoral GDP
...
the interactive HTML version of this manuscript
