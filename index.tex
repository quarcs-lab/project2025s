...
and independent variables of the convergence equations. Our tests
highlight that spatial autocorrelation is a relevant feature of
satellite data and the regional convergence process. Third, we employ a
spatial Durbin model that explicitly accounts for spatial spillovers and
quantify how neighbors can influence the speed of regional convergence.
...
Also, this article adopts a reproducible open-science approach by
leveraging Jupyter notebooks and the Quarto publishing system. Jupyter
notebooks allow researchers to integrate executable code, narrative
text, and computational outputs within a single document. They also
support multiple programming languages such as Python, R, Stata, among
others. Quarto is an open-source publishing system that generates
multiple output formats---including HTML, PDF, and Word---from a single
source file. This system ensures consistency across all versions of a
document and lowers the technical barriers to multiformat publishing.
The combined use of Jupyter and Quarto fosters scientific
reproducibility and open science by making every analytical step
transparent, verifiable, and accessible to other researchers.
...
This article reexamines the regional convergence hypothesis across
...
Our results also illustrates the usefulness of satellite nighttime
...
across administrative boundaries, particularly in large developing
...
output formats: HTML, PDF, Microsoft Word, among others. The interactive
HTML version is particulary useful as it allows readers to engage with
...
source code. Finally, by hosting the complete codebase and data in a
public Github repository and making the Python and R notebooks
executable in the cloud through Google Colaboratory, we aim to encourage
other researchers to further adopt reproducible open science practices
that can strengthen the credibility and extendability of scientific
research.
